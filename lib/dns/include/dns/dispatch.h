...
/*%<
 * Attach/Detach to a dispatch manger.
 */
...
/*<
 * Disconnects a dispatch response entry from its dispatch, cancel all
 * pending connects and reads in a dispatch entry and shutdown it down.
